...
public class Drive extends SubsystemBase {
    ...
    setpointGenerator =
        new SwerveSetpointGenerator(
            ...
            Units.rotationsToRadians(
                10.0) // The max rotation velocity of a swerve module in radians per second.
            );
   ...
   */
  public void addVisionMeasurement(PoseEstimate poseEstimate, Vector<N3> visionMeasurementStdDevs) {
    poseEstimator.addVisionMeasurement(
        poseEstimate.pose().toPose2d(), poseEstimate.timestampSeconds(), visionMeasurementStdDevs);
  }
    ...
    visionData.forEach(
        visionUpdate ->
            addVisionMeasurement(
                visionUpdate.poseEstimate(), visionUpdate.visionMeasurementStdDevs()));
  }
